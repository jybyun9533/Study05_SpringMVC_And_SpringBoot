...
public class PhoneDAOImpl implements IPhoneDAO{
	...
	public boolean insert(Phone phone) {
		return sqlSession.insert(NS+"insert",phone)==1? true: false;
	}

	@Override
	public boolean delete(List<String> list) {	
		return sqlSession.delete(NS+"delete", list)==1? true: false;
	}
	...
	public boolean update(Phone phone) {
		return sqlSession.update(NS+"update",phone)==1? true: false;
	}
}
