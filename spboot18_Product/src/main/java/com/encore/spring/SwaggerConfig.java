...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Encore API")
				...
				.contact(new Contact("Ha Seung Hyun", "https://playdata.io", "sueup@daum.net"))
				.license("Encore License 0.9").licenseUrl("https://www.en-core.com/consult/consult1").version("0.9")
				.build();
	}
}