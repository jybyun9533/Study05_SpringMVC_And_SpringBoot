...
<body>
	...
	<form action="api/addProduct" method="post">
		...
		<br> 제조사 : <input type="text" name="maker"><br>
		<br> 가 격 : <input type="text" name="price"><br>
	...
	<form action="api/myProductSearch">
		<select name="command">
		...
		</select> <input type="text" name="word"><br>
		<br> <input type="submit" value="상품찾기">
	</form>
</body>
</html>