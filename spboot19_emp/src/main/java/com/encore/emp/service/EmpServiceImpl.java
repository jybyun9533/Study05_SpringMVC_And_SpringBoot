...
public class EmpServiceImpl implements EmpService{
	...
	public List<EmployeeDto> findAllTitles() throws Exception {
		return empDao.findAllTitles();
	}

	@Override
	public List<Integer> findAllDepartments() throws Exception {
		return empDao.findAllDepartments();
	}
	
	@Override
	public List<EmployeeDto> findAllManagers() throws Exception {
		return empDao.findAllManagers();
	}
